...
import com.shevelev.wizard_camera.gallery_activity.model.GalleryActivityInteractorImpl
...
abstract class GalleryActivityModule {
    ...
    @Binds
    @ActivityScope
    abstract fun provideModel(model: GalleryActivityInteractorImpl): GalleryActivityInteractor
